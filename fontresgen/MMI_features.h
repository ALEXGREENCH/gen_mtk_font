...
#if (!defined(__MRE_PACKAGE_SLIM__))&&!defined(__PATCH_MRE_DISABLED__)
...
#endif
#else
#if (defined(__MMI_RES_TYPE_WALLPAPER_SEL__) && (__MMI_RES_TYPE_WALLPAPER_SEL__ == __RES_TYPE_BMP__)) 
	#ifndef __MMI_RES_TYPE_WALLPAPER__
	#define __MMI_RES_TYPE_WALLPAPER__	"BMP"
	#endif
#elif (defined(__MMI_RES_TYPE_WALLPAPER_SEL__) && (__MMI_RES_TYPE_WALLPAPER_SEL__ == __RES_TYPE_JPG__))
	#ifndef __MMI_RES_TYPE_WALLPAPER__
	#define __MMI_RES_TYPE_WALLPAPER__	"JPG"
	#endif
#elif (defined(__MMI_RES_TYPE_WALLPAPER_SEL__) && (__MMI_RES_TYPE_WALLPAPER_SEL__ == __RES_TYPE_GIF__))
	#ifndef __MMI_RES_TYPE_WALLPAPER__
	#define __MMI_RES_TYPE_WALLPAPER__	"GIF"
	#endif
#else
...
#if defined(CFG_MMI_IDLE_LUNAR_WEEKDAY_INFO) && ((CFG_MMI_IDLE_LUNAR_WEEKDAY_INFO == __ON__)||(CFG_MMI_IDLE_LUNAR_WEEKDAY_INFO == __AUTO__))&&\
    (defined(__MMI_MAINLCD_240X320__)||defined(__MMI_MAINLCD_176X220__))
    #ifndef MMI_IDLE_LUNAR_WEEKDAY_INFO_SUPPORT
    #define MMI_IDLE_LUNAR_WEEKDAY_INFO_SUPPORT
    #endif
#endif
